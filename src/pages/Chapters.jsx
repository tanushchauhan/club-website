    ...
    <div className="chaptersPage">
      ...
      <div className="why-box">
        ...
        <div className="why-information" ref={ref}>
          <h1 className="text-3xl pt-3 mt-[1vh] text-white">
          ...
          <div className="infobox-wrapper grid grid-cols-3 py-3">
            <div className="infobox-1">
              ...
              <div className="reason-1">
                <h2 className="font-bold text-[2vh]">
                  Give Back to Your Community
                </h2>
                <p>
                  Our chapters empower local communities through tech-driven
                  solutions. By creating a CSC chapter at your school, you
                  contribute to creating accessible and inclusive technology,
                  bridging the digital gap, and making a real impact where it
                  matters most.
                </p>
              </div>
            </div>
            <div className="infobox-2">
              ...
              <div className="reason-2">
                <h2 className="font-bold text-[2vh]">
                  Enrich Local Computer Science Education
                </h2>
                <p>
                  Join us in enhancing local software development education,
                  where members walk away with skills that open doors to
                  exciting employment opportunities. Our program focuses on
                  hands-on learning, cutting-edge technologies, and real-world
                  projects, ensuring that participants gain practical experience
            ...
            <div className="infobox-3">
              ...
              <div className="reason-3">
                ...
                <p>
                  Discover the transformative journey of learning to lead with
                  us. Starting a CSC chapter comes with a whole trove of
                  opportunity: from embracing adaptability to fostering chapter
                  development, you'll pick up on numerous leadership skills.
                  Join us on this dynamic journey of self-discovery and growth!
                </p>
              </div>
            </div>
          </div>
